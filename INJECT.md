...
- **Stack**: TypeScript 6.0 strict + React 19 + Vite/CRXJS + Chrome Manifest V3
- **Entry points**: `src/background/service-worker.ts` (SW), `src/devtools/panel.tsx` (UI), `src/injected/page-mock.ts` (fetch/XHR patch)
