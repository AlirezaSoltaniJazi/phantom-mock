# AI Interaction Guide — phantom-mock
...
- "Note: this project uses typed message schemas — I'll add the new type to `shared/messages.ts`"
- "Following our pattern, I'll use Shadow DOM for this injected UI"
- "Per SKILL.md, using `chrome.storage.local` with the typed wrapper"
